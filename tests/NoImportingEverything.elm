...
rule exceptions =
    Rule.newModuleRuleSchema "NoImportingEverything" (Rule.initContextCreator ())
        |> Rule.withImportVisitor (\import_ context -> ( importVisitor (exceptionsToSet exceptions) import_, context ))
